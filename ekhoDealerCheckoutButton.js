...
EkhoDealerButton.prototype.renderButton = function() {
  ...
  if (el) {
    ...
    p.innerHTML = "Checking out with Ekho Dealer allows you to finance, register, title, and schedule the delivery of your vehicle online in a couple of minutes. Ekho Dealer, LLC is a registered new vehicle dealer, licensed to sell our vehicles and products. <a href='https://ekhodealer.com' target='_blank'> Learn more</a>";
    el.appendChild(p);
  }
  else {
