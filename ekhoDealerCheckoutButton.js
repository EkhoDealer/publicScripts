...
EkhoDealerButton.prototype.renderButton = function() {
  ...
  if (el) {
    ...
    p.innerHTML = "Ekh Dealer, LLC is a registered new vehicle dealer, licensed to sell our vehicles and products. Checking out with Ekho Dealer allows you to finance, register, title, and schedule the delivery of your vehicle online in a couple of minutes. <a href='https://ekhodealer.com' target='_blank'> Learn more</a>";
    el.appendChild(p);
  }
  else {
